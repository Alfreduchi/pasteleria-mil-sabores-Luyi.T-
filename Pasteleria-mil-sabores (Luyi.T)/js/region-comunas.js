// Arreglo completo de Regiones y Comunas de Chile (Requisito: Arreglo de JS)
const regionesChile = [
    ...
    { region: "Región de Ñuble", comunas: ["Chillán", "Bulnes", "Cobquecura", "Coelemu", "Coihueco", "Chillán Viejo", "El Carmen", "Ninhue", "Ñiquén", "Pemuco", "Pinto", "Portezuelo", "Quillón", "Quirihue", "Ránquil", "San Carlos", "San Fabián", "San Ignacio", "San Nicolás", "Treguaco", "Yungay"] },
    ...
    { region: "Región de Aysén del Gral. Carlos Ibáñez del Campo", comunas: ["Coyhaique", "Lago Verde", "Aysén", "Cisnes", "Guaitecas", "Cochrane", "O’Higgins", "Tortel", "Chile Chico", "Río Ibáñez"] },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (selectRegion && selectComuna) {
        ...
        // Evento para filtrar comunas por región (Requisito: cite 646)
        selectRegion.addEventListener('change', (e) => {
            const regionNombre = e.target.value;
            selectComuna.innerHTML = '<option value="">-- Seleccione la comuna --</option>';
            
            if (regionNombre) {
                const regionEncontrada = regionesChile.find(r => r.region === regionNombre);
